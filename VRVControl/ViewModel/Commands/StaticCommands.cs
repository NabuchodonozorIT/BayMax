...
namespace VRVControl.ViewModel.Commands
{
    public static class StaticCommands
    {
        ...
        private static readonly RoutedUICommand shutdownCommand = new RoutedUICommand("description", "ShutdownCommand", typeof(StaticCommands));

        public static RoutedUICommand ShutdownCommand
        {
            get
            {
        ...
        private static readonly RoutedUICommand bayMaxCommand = new RoutedUICommand("description", "BayMaxCommand", typeof(StaticCommands));

        public static RoutedUICommand BayMaxCommand
        {
            get
            {
                return bayMaxCommand;
            }
        }
